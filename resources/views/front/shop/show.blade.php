                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="front/img/img/products/{{$product->productImages[0]->path}}" alt="">
                                <div class="zoom-icon">
                                    ...
                                    <div class="comment-option">
                                        ...
                                        <div class="co-item">
                                            <div class="avatar-pic">
                                                <img src="front/img/product-single/{{$productComment->user->avatar ?? 'avatar-0.png'}}" alt="">
                                            </div>
